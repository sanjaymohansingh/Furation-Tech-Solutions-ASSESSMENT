      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          ...
          <MDBCol md="2" lg="2" xl="2" className="mx-auto mt-3">
            ...
            <p>
              <a href="https://akshatjalan.github.io//">Portfolio</a>
            </p>
            <p>
              <a href="https://akshatjalan.github.io/">Gaming Website</a>
            </p>
          </MDBCol>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> sanjaysingh19p@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +91 000000000
            </p>
            <p>
              <i className="fa fa-home mr-3" /> Uttar Pradesh
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
              ...
              <ul className="list-unstyled list-inline">
                <li className="list-inline-item">
                  <a
                    ...
                    href="http://github.com/sanjaymohansingh"
                  >
